...
public class VerifyOdometryCommand extends Command {
  ...
  public void initialize() {
    ...
    hasStatusCodeError = (driveSubsystem.setNeutralMode(NeutralModeValue.Coast) == StatusCode.OK) ? false : true;
  ...
  public void end(boolean interrupted) {
    ...
    for (int i = 0; i < 4; ++i) {
      ...
      System.out.println(
          "Module " + i + " distance (meters): " + driveSubsystem.getModuleDistanceMeters(i));
      System.out.println(
    ...
    hasStatusCodeError = (driveSubsystem.setNeutralMode(NeutralModeValue.Brake) == StatusCode.OK) ? false : true;
    if (hasStatusCodeError) {
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addDoubleProperty("Module 0 Distance (meters)",
        () -> driveSubsystem.getModuleDistanceMeters(0), null);
    builder.addDoubleProperty("Module 1 Distance (meters)",
        () -> driveSubsystem.getModuleDistanceMeters(1), null);
    builder.addDoubleProperty("Module 2 Distance (meters)",
        () -> driveSubsystem.getModuleDistanceMeters(2), null);
    builder.addDoubleProperty("Module 3 Distance (meters)",
        () -> driveSubsystem.getModuleDistanceMeters(3), null);
  }
}
